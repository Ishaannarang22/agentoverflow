...
//float3 Port_Normal_N000 4384
//float Port_Exponent_N000 4400
//float Port_Intensity_N000 4404
//float depthRef 4408
//}
...
float Rim_N0=0.0;
float3 param_1=(*sc_set0.UserUniforms).Port_Normal_N000;
float param_2=(*sc_set0.UserUniforms).Port_Exponent_N000;
float param_3=(*sc_set0.UserUniforms).Port_Intensity_N000;
...
float l9_1=abs(dot(-param_5.ViewDirWS,param_1));
float param_4=pow(1.0-l9_1,param_2);
...
float4 l9_5=fast::max(param_7,float4(0.0));
float4 param_8=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{
