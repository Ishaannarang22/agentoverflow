...
//float4 Tweak_N119 4384
//float Tweak_N1 4400
//float Tweak_N8 4404
//float alpha 4408
//float3 Port_Normal_N041 4416
//float depthRef 4432
//}
...
float4 param_1=(*sc_set0.UserUniforms).Tweak_N119;
Output_N119=param_1;
float Output_N1=0.0;
float param_2=(*sc_set0.UserUniforms).Tweak_N1;
Output_N1=param_2;
float Output_N8=0.0;
float param_3=(*sc_set0.UserUniforms).Tweak_N8;
Output_N8=param_3;
float Rim_N41=0.0;
float3 param_4=(*sc_set0.UserUniforms).Port_Normal_N041;
...
float l9_1=abs(dot(-param_8.ViewDirWS,param_4));
float param_7=pow(1.0-l9_1,param_5);
...
float4 l9_5=fast::max(param_11,float4(0.0));
float4 param_12=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{
