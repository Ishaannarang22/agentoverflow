...
//}
//ubo int UserUniforms 0:33:5008 {
//float4 sc_Time 1376
...
//float notification_tile_lightness 4384
//float notification_outline_lightness 4388
//float3x3 notification_outline_maskTransform 4448
//float4 notification_outline_maskUvMinMax 4496
//float4 notification_outline_maskBorderColor 4512
//float Tweak_N12 4528
//float notification_tile_opacity 4532
//float Port_Input1_N018 4536
//float Port_Input1_N021 4540
//float4 Port_Import_N038 4544
//float4 Port_Import_N039 4560
...
//float2 Port_Offset_N003 4640
//float Port_Rotation_N007 4648
//float2 Port_Center_N007 4656
//float4 Port_Value0_N001 4672
//float Port_Position1_N001 4688
//float4 Port_Value1_N001 4704
//float Port_Position2_N001 4720
//float4 Port_Value2_N001 4736
//float4 Port_Value3_N001 4752
//float2 Port_Offset_N022 4768
//float Port_Rotation_N023 4776
//float2 Port_Center_N023 4784
//float3 Port_Value0_N000 4800
//float Port_Position1_N000 4816
//float3 Port_Value1_N000 4832
//float Port_Position2_N000 4848
//float3 Port_Value2_N000 4864
//float3 Port_Value3_N000 4880
//float4 Port_Import_N031 4896
//float4 Port_Import_N032 4912
//float Port_Input0_N049 4928
//float Port_Input1_N049 4932
//float Port_RangeMinA_N035 4936
//float Port_RangeMaxA_N035 4940
//float Port_RangeMinB_N035 4944
//float Port_RangeMaxB_N035 4948
//float2 Port_Import_N036 4952
//float2 Port_Center_N037 4960
//float2 Port_Import_N040 4968
//float2 Port_Import_N042 4976
//float Port_Input1_N048 4984
//float Port_Input2_N048 4988
//float depthRef 5000
//}
...
float param_4=(*sc_set0.UserUniforms).Port_Rotation_N007;
float2 param_5=(*sc_set0.UserUniforms).Port_Center_N007;
float l9_1=sin(radians(param_4));
float l9_2=cos(radians(param_4));
float2 param_6=param_3-param_5;
param_6=float2(dot(float2(l9_2,l9_1),param_6),dot(float2(-l9_1,l9_2),param_6))+param_5;
CoordsOut_N7=param_6;
float4 Value_N1=float4(0.0);
float param_7=CoordsOut_N7.x;
float4 param_8=(*sc_set0.UserUniforms).Port_Value0_N001;
float param_9=(*sc_set0.UserUniforms).Port_Position1_N001;
float4 param_10=(*sc_set0.UserUniforms).Port_Value1_N001;
float param_11=(*sc_set0.UserUniforms).Port_Position2_N001;
float4 param_12=(*sc_set0.UserUniforms).Port_Value2_N001;
float4 param_13=(*sc_set0.UserUniforms).Port_Value3_N001;
param_7=fast::clamp(param_7,0.0,1.0);
float4 param_14;
if (param_7<param_9)
{
param_14=mix(param_8,param_10,float4(fast::clamp(param_7/param_9,0.0,1.0)));
}
else
{
if (param_7<param_11)
{
param_14=mix(param_10,param_12,float4(fast::clamp((param_7-param_9)/(param_11-param_9),0.0,1.0)));
}
else
{
param_14=mix(param_12,param_13,float4(fast::clamp((param_7-param_11)/(1.0-param_11),0.0,1.0)));
}
}
...
if (l9_4)
{
l9_5=1==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_5=l9_4;
...
float param_15=(*sc_set0.UserUniforms).notification_tile_lightness;
Output_N27=param_15;
...
float2 param_16=CoordsOut_N22;
float param_17=(*sc_set0.UserUniforms).Port_Rotation_N023;
float2 param_18=(*sc_set0.UserUniforms).Port_Center_N023;
float l9_6=sin(radians(param_17));
float l9_7=cos(radians(param_17));
float2 param_19=param_16-param_18;
param_19=float2(dot(float2(l9_7,l9_6),param_19),dot(float2(-l9_6,l9_7),param_19))+param_18;
CoordsOut_N23=param_19;
float3 Value_N0=float3(0.0);
float param_20=CoordsOut_N23.x;
float3 param_21=(*sc_set0.UserUniforms).Port_Value0_N000;
float param_22=(*sc_set0.UserUniforms).Port_Position1_N000;
float3 param_23=(*sc_set0.UserUniforms).Port_Value1_N000;
float param_24=(*sc_set0.UserUniforms).Port_Position2_N000;
float3 param_25=(*sc_set0.UserUniforms).Port_Value2_N000;
float3 param_26=(*sc_set0.UserUniforms).Port_Value3_N000;
param_20=fast::clamp(param_20,0.0,1.0);
float3 param_27;
if (param_20<param_22)
{
param_27=mix(param_21,param_23,float3(fast::clamp(param_20/param_22,0.0,1.0)));
}
else
{
if (param_20<param_24)
{
param_27=mix(param_23,param_25,float3(fast::clamp((param_20-param_22)/(param_24-param_22),0.0,1.0)));
}
else
{
param_27=mix(param_25,param_26,float3(fast::clamp((param_20-param_24)/(1.0-param_24),0.0,1.0)));
}
}
...
if (l9_9)
{
l9_10=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_10=l9_9;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=float4(param_27,1.0);
PreviewInfo.Color.w=1.0;
}
Value_N0=param_27;
float Output_N5=0.0;
float param_28=(*sc_set0.UserUniforms).notification_outline_lightness;
Output_N5=param_28;
...
int l9_16=l9_11;
int param_29=notification_outline_maskLayout_tmp;
int param_30=l9_16;
float2 param_31=UVCoord_N2;
bool param_32=(int(SC_USE_UV_TRANSFORM_notification_outline_mask_tmp)!=0);
float3x3 param_33=(*sc_set0.UserUniforms).notification_outline_maskTransform;
int2 param_34=int2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask_tmp,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask_tmp);
bool param_35=(int(SC_USE_UV_MIN_MAX_notification_outline_mask_tmp)!=0);
float4 param_36=(*sc_set0.UserUniforms).notification_outline_maskUvMinMax;
bool param_37=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask_tmp)!=0);
float4 param_38=(*sc_set0.UserUniforms).notification_outline_maskBorderColor;
float param_39=0.0;
bool l9_17=param_37&&(!param_35);
float l9_18=1.0;
float l9_19=param_31.x;
int l9_20=param_34.x;
if (l9_20==1)
{
l9_19=fract(l9_19);
}
...
param_31.x=l9_19;
float l9_24=param_31.y;
int l9_25=param_34.y;
if (l9_25==1)
{
l9_24=fract(l9_24);
}
...
float l9_31=param_31.x;
float l9_32=param_36.x;
float l9_33=param_36.z;
bool l9_34=l9_30;
float l9_35=l9_18;
...
float l9_40=param_31.y;
float l9_41=param_36.y;
float l9_42=param_36.w;
bool l9_43=l9_39;
float l9_44=l9_18;
...
float2 l9_47=param_31;
bool l9_48=param_32;
float3x3 l9_49=param_33;
if (l9_48)
{
...
float2 l9_50=l9_47;
param_31=l9_50;
float l9_51=param_31.x;
int l9_52=param_34.x;
bool l9_53=l9_17;
float l9_54=l9_18;
if ((l9_52==0)||(l9_52==3))
{
...
param_31.x=l9_51;
l9_18=l9_54;
float l9_62=param_31.y;
int l9_63=param_34.y;
bool l9_64=l9_17;
float l9_65=l9_18;
if ((l9_63==0)||(l9_63==3))
{
...
param_31.y=l9_62;
l9_18=l9_65;
float2 l9_73=param_31;
int l9_74=param_29;
int l9_75=param_30;
float l9_76=param_39;
float2 l9_77=l9_73;
int l9_78=l9_74;
int l9_79=l9_75;
...
float3 l9_81=l9_80;
float3 l9_82=l9_81;
float4 l9_83=sc_set0.notification_outline_mask.sample(sc_set0.notification_outline_maskSmpSC,l9_82.xy,bias(l9_76));
float4 l9_84=l9_83;
if (param_37)
{
l9_84=mix(param_38,l9_84,float4(l9_18));
}
float4 l9_85=l9_84;
Color_N11=l9_85;
...
float param_40=(*sc_set0.UserUniforms).Tweak_N12;
Output_N12=param_40;
float4 Output_N29=float4(0.0);
Output_N29=Color_N11*float4(Output_N12);
float Output_N8=0.0;
float param_41=(*sc_set0.UserUniforms).notification_tile_opacity;
Output_N8=param_41;
float4 Output_N30=float4(0.0);
float4 param_43=Output_N29;
float4 param_44=float4(Output_N8);
float4 l9_86=param_43;
float4 l9_87=param_44;
float3 l9_88=l9_86.xyz*l9_86.w;
l9_86=float4(l9_88.x,l9_88.y,l9_88.z,l9_86.w);
float4 param_42=fast::min(l9_86+l9_87,float4(1.0));
Output_N30=param_42;
float4 Output_N53=float4(0.0);
float4 param_46=Export_N51;
float4 param_47=Output_N30;
float4 l9_89=param_46;
float4 l9_90=param_47;
float3 l9_91=l9_89.xyz*l9_89.w;
l9_89=float4(l9_91.x,l9_91.y,l9_91.z,l9_89.w);
float4 param_45=fast::min(l9_89+l9_90,float4(1.0));
Output_N53=param_45;
...
float4 l9_95=fast::max(param_49,float4(0.0));
float4 param_50=l9_95;
if (sc_ShaderCacheConstant_tmp!=0)
{
