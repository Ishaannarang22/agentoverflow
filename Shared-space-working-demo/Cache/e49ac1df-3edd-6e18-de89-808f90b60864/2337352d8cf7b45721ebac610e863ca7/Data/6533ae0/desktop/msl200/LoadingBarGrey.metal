...
//float Port_Import_N062 4528
//float3 Port_Import_N052 4544
//float3 Port_Input1_N058 4560
//float Port_Input1_N070 4592
//float Port_Input1_N075 4596
//float2 Port_Input1_N083 4600
//float Port_Import_N059 4608
//float Port_Import_N060 4612
//float Port_Value2_N003 4616
//float depthRef 4620
//}
...
int l9_10=l9_5;
int param_8=Tweak_N1Layout_tmp;
int param_9=l9_10;
float2 param_10=Output_N19;
bool param_11=(int(SC_USE_UV_TRANSFORM_Tweak_N1_tmp)!=0);
float3x3 param_12=(*sc_set0.UserUniforms).Tweak_N1Transform;
int2 param_13=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1_tmp);
bool param_14=(int(SC_USE_UV_MIN_MAX_Tweak_N1_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).Tweak_N1UvMinMax;
bool param_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1_tmp)!=0);
float4 param_17=(*sc_set0.UserUniforms).Tweak_N1BorderColor;
float param_18=0.0;
...
float3 l9_75=l9_74;
float3 l9_76=l9_75;
float4 l9_77=sc_set0.Tweak_N1.sample(sc_set0.Tweak_N1SmpSC,l9_76.xy,bias(l9_70));
float4 l9_78=l9_77;
if (param_16)
{
...
float4 param_22=Value_N3;
float3 l9_84=fast::min(param_21.xyz+param_22.xyz,float3(1.0));
float4 param_23;
param_23=float4(l9_84.x,l9_84.y,l9_84.z,param_23.w);
float3 l9_85=mix(param_21.xyz,param_23.xyz,float3(param_22.w));
param_23=float4(l9_85.x,l9_85.y,l9_85.z,param_23.w);
param_23.w=param_21.w;
Output_N2=param_23;
...
float4 l9_89=fast::max(param_25,float4(0.0));
float4 param_26=l9_89;
if (sc_ShaderCacheConstant_tmp!=0)
{
