...
//}
//ubo int UserUniforms 0:35:4944 {
//float4 sc_Time 1376
...
//float status 4512
//float3x3 additional_setting_btn_icon_texTransform 4576
//float4 additional_setting_btn_icon_texUvMinMax 4624
//float4 additional_setting_btn_icon_texBorderColor 4640
//float alpha 4656
//float Port_Import_N006 4660
//float3 Port_Import_N049 4672
//float Port_Input1_N053 4688
//float Port_Input2_N053 4692
//float Port_Import_N062 4696
...
//float Port_Position1_N021 4848
//float4 Port_Input1_N034 4864
//float3 Port_Normal_N031 4880
//float Port_Exponent_N031 4896
//float Port_Intensity_N031 4900
//float Port_Position2_N021 4904
//float2 Port_Scale_N002 4912
//float2 Port_Center_N002 4920
//float Port_Position1_N136 4928
//float Port_Position2_N136 4932
//float Port_Value2_N003 4936
//float depthRef 4940
//}
...
float param_27=(*sc_set0.UserUniforms).status;
Output_N22=param_27;
...
float param_28=Output_N10;
float4 param_29=(*sc_set0.UserUniforms).Port_Value0_N007;
float param_30=(*sc_set0.UserUniforms).Port_Position1_N007;
float4 param_31=(*sc_set0.UserUniforms).Port_Value1_N007;
float param_32=(*sc_set0.UserUniforms).Port_Position2_N007;
float4 param_33=(*sc_set0.UserUniforms).Port_Value2_N007;
float4 param_34=(*sc_set0.UserUniforms).Port_Value3_N007;
param_28=fast::clamp(param_28,0.0,1.0);
float4 param_35;
if (param_28<param_30)
{
param_35=mix(param_29,param_31,float4(fast::clamp(param_28/param_30,0.0,1.0)));
}
else
{
if (param_28<param_32)
{
param_35=mix(param_31,param_33,float4(fast::clamp((param_28-param_30)/(param_32-param_30),0.0,1.0)));
}
else
{
param_35=mix(param_33,param_34,float4(fast::clamp((param_28-param_32)/(1.0-param_32),0.0,1.0)));
}
}
...
float l9_164=abs(dot(-param_40.ViewDirWS,param_36));
float param_39=pow(1.0-l9_164,param_37);
...
float param_41=Output_N22;
float4 param_42=Value_N7;
float param_43=(*sc_set0.UserUniforms).Port_Position1_N021;
float4 param_44=Output_N34;
float param_45=(*sc_set0.UserUniforms).Port_Position2_N021;
float4 param_46=Value_N7;
float4 param_47=Output_N34;
param_41=fast::clamp(param_41,0.0,1.0);
float4 param_48;
if (param_41<param_43)
{
param_48=mix(param_42,param_44,float4(fast::clamp(param_41/param_43,0.0,1.0)));
}
else
{
if (param_41<param_45)
{
param_48=mix(param_44,param_46,float4(fast::clamp((param_41-param_43)/(param_45-param_43),0.0,1.0)));
}
else
{
param_48=mix(param_46,param_47,float4(fast::clamp((param_41-param_45)/(1.0-param_45),0.0,1.0)));
}
}
bool l9_165=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_166;
if (l9_165)
{
l9_166=!PreviewInfo.Saved;
}
else
{
l9_166=l9_165;
...
if (l9_166)
{
l9_167=21==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_167=l9_166;
...
int l9_173=l9_168;
int param_49=additional_setting_btn_icon_texLayout_tmp;
int param_50=l9_173;
float2 param_51=CoordsOut_N2;
bool param_52=(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex_tmp)!=0);
float3x3 param_53=(*sc_set0.UserUniforms).additional_setting_btn_icon_texTransform;
int2 param_54=int2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex_tmp,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex_tmp);
bool param_55=(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex_tmp)!=0);
float4 param_56=(*sc_set0.UserUniforms).additional_setting_btn_icon_texUvMinMax;
bool param_57=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex_tmp)!=0);
float4 param_58=(*sc_set0.UserUniforms).additional_setting_btn_icon_texBorderColor;
float param_59=0.0;
bool l9_174=param_57&&(!param_55);
float l9_175=1.0;
float l9_176=param_51.x;
int l9_177=param_54.x;
if (l9_177==1)
{
l9_176=fract(l9_176);
}
...
param_51.x=l9_176;
float l9_181=param_51.y;
int l9_182=param_54.y;
if (l9_182==1)
{
l9_181=fract(l9_181);
}
...
float l9_188=param_51.x;
float l9_189=param_56.x;
float l9_190=param_56.z;
bool l9_191=l9_187;
float l9_192=l9_175;
...
float l9_197=param_51.y;
float l9_198=param_56.y;
float l9_199=param_56.w;
bool l9_200=l9_196;
float l9_201=l9_175;
...
float2 l9_204=param_51;
bool l9_205=param_52;
float3x3 l9_206=param_53;
if (l9_205)
{
...
param_51=l9_207;
float l9_208=param_51.x;
int l9_209=param_54.x;
bool l9_210=l9_174;
float l9_211=l9_175;
...
param_51.x=l9_208;
l9_175=l9_211;
float l9_219=param_51.y;
int l9_220=param_54.y;
bool l9_221=l9_174;
float l9_222=l9_175;
...
param_51.y=l9_219;
l9_175=l9_222;
float2 l9_230=param_51;
int l9_231=param_49;
int l9_232=param_50;
float l9_233=param_59;
...
float4 l9_240=sc_set0.additional_setting_btn_icon_tex.sample(sc_set0.additional_setting_btn_icon_texSmpSC,l9_239.xy,bias(l9_233));
float4 l9_241=l9_240;
if (param_57)
{
l9_241=mix(param_58,l9_241,float4(l9_175));
}
...
int l9_248=l9_243;
int param_60=additional_setting_btn_icon_texLayout_tmp;
int param_61=l9_248;
float2 param_62=CoordsOut_N2;
bool param_63=(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex_tmp)!=0);
float3x3 param_64=(*sc_set0.UserUniforms).additional_setting_btn_icon_texTransform;
int2 param_65=int2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex_tmp,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex_tmp);
bool param_66=(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex_tmp)!=0);
float4 param_67=(*sc_set0.UserUniforms).additional_setting_btn_icon_texUvMinMax;
bool param_68=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex_tmp)!=0);
float4 param_69=(*sc_set0.UserUniforms).additional_setting_btn_icon_texBorderColor;
float param_70=0.0;
bool l9_249=param_68&&(!param_66);
float l9_250=1.0;
float l9_251=param_62.x;
int l9_252=param_65.x;
if (l9_252==1)
{
l9_251=fract(l9_251);
}
...
param_62.x=l9_251;
float l9_256=param_62.y;
int l9_257=param_65.y;
if (l9_257==1)
{
l9_256=fract(l9_256);
}
...
float l9_263=param_62.x;
float l9_264=param_67.x;
float l9_265=param_67.z;
bool l9_266=l9_262;
float l9_267=l9_250;
...
float l9_272=param_62.y;
float l9_273=param_67.y;
float l9_274=param_67.w;
bool l9_275=l9_271;
float l9_276=l9_250;
...
float2 l9_279=param_62;
bool l9_280=param_63;
float3x3 l9_281=param_64;
if (l9_280)
{
...
param_62=l9_282;
float l9_283=param_62.x;
int l9_284=param_65.x;
bool l9_285=l9_249;
float l9_286=l9_250;
...
param_62.x=l9_283;
l9_250=l9_286;
float l9_294=param_62.y;
int l9_295=param_65.y;
bool l9_296=l9_249;
float l9_297=l9_250;
...
param_62.y=l9_294;
l9_250=l9_297;
float2 l9_305=param_62;
int l9_306=param_60;
int l9_307=param_61;
float l9_308=param_70;
...
float4 l9_315=sc_set0.additional_setting_btn_icon_tex.sample(sc_set0.additional_setting_btn_icon_texSmpSC,l9_314.xy,bias(l9_308));
float4 l9_316=l9_315;
if (param_68)
{
l9_316=mix(param_69,l9_316,float4(l9_250));
}
float4 l9_317=l9_316;
Color_N15=l9_317;
float4 Value_N136=float4(0.0);
float param_71=Output_N22;
float4 param_72=Color_N30;
float param_73=(*sc_set0.UserUniforms).Port_Position1_N136;
float4 param_74=Color_N30;
float param_75=(*sc_set0.UserUniforms).Port_Position2_N136;
float4 param_76=Color_N15;
float4 param_77=Color_N15;
param_71=fast::clamp(param_71,0.0,1.0);
float4 param_78;
if (param_71<param_73)
{
param_78=mix(param_72,param_74,float4(fast::clamp(param_71/param_73,0.0,1.0)));
}
else
{
if (param_71<param_75)
{
param_78=mix(param_74,param_76,float4(fast::clamp((param_71-param_73)/(param_75-param_73),0.0,1.0)));
}
else
{
param_78=mix(param_76,param_77,float4(fast::clamp((param_71-param_75)/(1.0-param_75),0.0,1.0)));
}
}
bool l9_318=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_319;
if (l9_318)
{
l9_319=!PreviewInfo.Saved;
}
else
{
l9_319=l9_318;
...
if (l9_319)
{
l9_320=136==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_320=l9_319;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=param_78;
PreviewInfo.Color.w=1.0;
}
Value_N136=param_78;
float3 Value1_N13=float3(0.0);
float Value2_N13=0.0;
float4 param_79=Value_N136;
float3 param_80=param_79.xyz;
float param_81=param_79.w;
Value1_N13=param_80;
Value2_N13=param_81;
...
float param_82=(*sc_set0.UserUniforms).alpha;
Output_N18=param_82;
...
float param_83=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_83<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_324=fast::max(param_84,float4(0.0));
float4 param_85=l9_324;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_85.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=param_85;
return out;
}
float4 param_86=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_325=param_86;
...
{
l9_327=fast::clamp(l9_326.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_327=fast::clamp(dot(l9_326.xyz,float3(l9_326.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_327=(1.0-dot(l9_326.xyz,float3(0.33333001)))*l9_326.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_327=(1.0-fast::clamp(dot(l9_326.xyz,float3(1.0)),0.0,1.0))*l9_326.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_327=fast::clamp(dot(l9_326.xyz,float3(1.0)),0.0,1.0)*l9_326.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_327=fast::clamp(dot(l9_326.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_327=dot(l9_326.xyz,float3(0.33333001))*l9_326.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_327=1.0-fast::clamp(dot(l9_326.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_328=l9_327;
float l9_329=l9_328;
float l9_330=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_329;
float3 l9_331=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_325.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_332=float4(l9_331.x,l9_331.y,l9_331.z,l9_330);
param_86=l9_332;
}
else
{
...
{
param_86=float4(param_86.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_333=param_86;
float4 l9_334=float4(0.0);
float4 l9_335=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_336=out.FragColor0;
...
float2 l9_339=l9_338.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_344=l9_343;
int l9_345=l9_344;
float3 l9_346=float3(l9_340,0.0);
int l9_347=l9_342;
int l9_348=l9_345;
if (l9_347==1)
{
l9_346.y=((2.0*l9_346.y)+float(l9_348))-1.0;
}
float2 l9_349=l9_346.xy;
l9_341=l9_349;
}
else
{
...
int l9_362=sc_ScreenTextureLayout_tmp;
int l9_363=l9_360;
float l9_364=l9_354;
...
float4 l9_371=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_370.xy,bias(l9_364));
float4 l9_372=l9_371;
float4 l9_373=l9_372;
l9_335=l9_373;
}
float4 l9_374=l9_335;
float3 l9_375=l9_374.xyz;
float3 l9_376=l9_375;
float3 l9_377=l9_333.xyz;
float3 l9_378=definedBlend(l9_376,l9_377,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_334=float4(l9_378.x,l9_378.y,l9_378.z,l9_334.w);
float3 l9_379=mix(l9_375,l9_334.xyz,float3(l9_333.w));
l9_334=float4(l9_379.x,l9_379.y,l9_379.z,l9_334.w);
l9_334.w=1.0;
float4 l9_380=l9_334;
param_86=l9_380;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_381=float4(in.varScreenPos.xyz,1.0);
param_86=l9_381;
}
else
{
...
float l9_383=fast::clamp(abs(l9_382.z),0.0,1.0);
float4 l9_384=float4(l9_383,1.0-l9_383,1.0,1.0);
param_86=l9_384;
}
else
{
float4 l9_385=param_86;
float4 l9_386=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_386=float4(mix(float3(1.0),l9_385.xyz,float3(l9_385.w)),l9_385.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_387=l9_385.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_387=fast::clamp(l9_387,0.0,1.0);
}
l9_386=float4(l9_385.xyz*l9_387,l9_387);
}
else
{
l9_386=l9_385;
...
float3 param_87=in.varPos;
float4 param_88=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_87,param_88,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_89=FinalColor;
float4 l9_392=param_89;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_392.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_392;
return out;
}
} // FRAGMENT SHADER
