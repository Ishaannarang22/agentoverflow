...
//float Tweak_N47 4512
//float Tweak_N2 4516
//float4 baseColor 4528
//float Tweak_N41 4544
//float4 Port_Input0_N102 4560
//float2 Port_Center_N046 4576
//float Port_Import_N092 4608
//float4 Port_Input1_N094 4624
//float Port_Import_N100 4644
//float depthRef 4648
//}
...
float param_1=(*sc_set0.UserUniforms).Tweak_N47;
Output_N47=param_1;
...
int l9_6=l9_1;
int param_2=Tweak_N42Layout_tmp;
int param_3=l9_6;
float2 param_4=CoordsOut_N46;
bool param_5=(int(SC_USE_UV_TRANSFORM_Tweak_N42_tmp)!=0);
float3x3 param_6=(*sc_set0.UserUniforms).Tweak_N42Transform;
int2 param_7=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N42_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N42_tmp);
bool param_8=(int(SC_USE_UV_MIN_MAX_Tweak_N42_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).Tweak_N42UvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N42_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).Tweak_N42BorderColor;
float param_12=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.Tweak_N42.sample(sc_set0.Tweak_N42SmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_10)
{
...
float Output_N2=0.0;
float param_13=(*sc_set0.UserUniforms).Tweak_N2;
Output_N2=param_13;
float Value_N95=0.0;
...
float param_15=(*sc_set0.UserUniforms).Tweak_N41;
Output_N41=param_15;
