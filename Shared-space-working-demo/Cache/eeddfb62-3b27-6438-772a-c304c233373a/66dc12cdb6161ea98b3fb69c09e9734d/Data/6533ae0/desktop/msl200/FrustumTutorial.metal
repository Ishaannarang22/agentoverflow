...
//float3x3 Tweak_N42Transform 4432
//float4 Tweak_N42UvMinMax 4480
//float4 Tweak_N42BorderColor 4496
//float Tweak_N80 4512
//float3x3 Tweak_N41Transform 4576
//float4 Tweak_N41UvMinMax 4624
//float4 Tweak_N41BorderColor 4640
//float4 Tweak_N46 4656
//float Tweak_N85 4672
//float3x3 Tweak_N99Transform 4736
//float4 Tweak_N99UvMinMax 4784
//float4 Tweak_N99BorderColor 4800
//float Port_Import_N057 4832
//float Port_RangeMinA_N070 4836
//float Port_RangeMaxA_N070 4840
//float Port_RangeMinB_N070 4844
//float Port_RangeMaxB_N070 4848
//float Port_Input1_N073 4856
//float Port_Import_N074 4860
//float Port_Input1_N075 4864
//float4 Port_Input1_N097 4880
//float2 Port_Seed_N083 4896
//float2 Port_Scale_N092 4904
//float2 Port_Center_N092 4912
//float depthRef 4920
//}
...
int param_2=l9_8;
float2 param_3=Globals.Surface_UVCoord1;
...
float param_11=0.0;
bool l9_9=param_9&&(!param_7);
float l9_10=1.0;
float l9_11=param_3.x;
int l9_12=param_6.x;
if (l9_12==1)
{
l9_11=fract(l9_11);
...
float l9_23=param_3.x;
float l9_24=param_8.x;
float l9_25=param_8.z;
bool l9_26=l9_22;
float l9_27=l9_10;
...
float l9_32=param_3.y;
float l9_33=param_8.y;
float l9_34=param_8.w;
bool l9_35=l9_31;
float l9_36=l9_10;
...
float2 l9_39=param_3;
bool l9_40=param_4;
float3x3 l9_41=param_5;
if (l9_40)
{
...
param_3.y=l9_54;
l9_10=l9_57;
float2 l9_65=param_3;
int l9_66=param_1;
int l9_67=param_2;
float l9_68=param_11;
float2 l9_69=l9_65;
int l9_70=l9_66;
int l9_71=l9_67;
...
float3 l9_73=l9_72;
float3 l9_74=l9_73;
float4 l9_75=sc_set0.Tweak_N42.sample(sc_set0.Tweak_N42SmpSC,l9_74.xy,bias(l9_68));
float4 l9_76=l9_75;
if (param_9)
{
l9_76=mix(param_10,l9_76,float4(l9_10));
}
float4 l9_77=l9_76;
Output_N42=l9_77;
...
float3 param_12=Value_N48.xyz;
float3 l9_78=float3(0.0);
float3 l9_79=param_12;
float3 l9_80=fast::clamp(l9_79,float3(0.0),float3(1.0));
param_12=l9_80;
float l9_81=fast::max(fast::max(param_12.x,param_12.y),param_12.z);
l9_78.z=l9_81;
float l9_82=l9_81-fast::min(fast::min(param_12.x,param_12.y),param_12.z);
float3 l9_83=float3(0.0,0.33333334,0.66666669)+(((param_12.yzx-param_12.zxy)*0.16666667)/float3(l9_82));
float2 l9_84;
if (l9_82==0.0)
{
l9_84=float2(0.0);
...
l9_84=float2(l9_85,l9_82/l9_81);
}
l9_78=float3(l9_84.x,l9_84.y,l9_78.z);
float3 l9_87=l9_78;
HSV_N54=float4(l9_87,Value_N48.w);
float Value_N57=0.0;
...
float param_13=(*sc_set0.UserUniforms).Tweak_N80;
Output_N80=param_13;
float Value_N72=0.0;
...
float3 param_14=Output_N77.xyz;
float3 l9_88=param_14.zzz;
float l9_89=3.0*fract(param_14.x+0.16666667);
float l9_90=2.0*fract(l9_89);
float l9_91=param_14.y;
float l9_92=fast::clamp(l9_91,0.0,1.0);
float2 l9_93=l9_88.yz-((float2(1.0,l9_90)-float2(fast::max(0.0,l9_90-1.0)))*(param_14.z*l9_92));
l9_88=float3(l9_88.x,l9_93.x,l9_93.y);
if (l9_89>=1.0)
{
l9_88=l9_88.zxy;
}
...
float3 l9_94=l9_88;
RGB_N78=float4(l9_94,Output_N77.w);
...
int l9_100=l9_95;
int param_15=Tweak_N41Layout_tmp;
int param_16=l9_100;
float2 param_17=Globals.Surface_UVCoord0;
bool param_18=(int(SC_USE_UV_TRANSFORM_Tweak_N41_tmp)!=0);
float3x3 param_19=(*sc_set0.UserUniforms).Tweak_N41Transform;
int2 param_20=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N41_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N41_tmp);
bool param_21=(int(SC_USE_UV_MIN_MAX_Tweak_N41_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).Tweak_N41UvMinMax;
bool param_23=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N41_tmp)!=0);
float4 param_24=(*sc_set0.UserUniforms).Tweak_N41BorderColor;
float param_25=0.0;
...
param_17=l9_134;
float l9_135=param_17.x;
int l9_136=param_20.x;
bool l9_137=l9_101;
float l9_138=l9_102;
...
param_17.x=l9_135;
l9_102=l9_138;
float l9_146=param_17.y;
int l9_147=param_20.y;
bool l9_148=l9_101;
float l9_149=l9_102;
...
float4 l9_167=sc_set0.Tweak_N41.sample(sc_set0.Tweak_N41SmpSC,l9_166.xy,bias(l9_160));
float4 l9_168=l9_167;
if (param_23)
{
l9_168=mix(param_24,l9_168,float4(l9_102));
}
float4 l9_169=l9_168;
Output_N41=l9_169;
float4 Output_N46=float4(0.0);
float4 param_26=(*sc_set0.UserUniforms).Tweak_N46;
Output_N46=param_26;
float4 Output_N45=float4(0.0);
Output_N45=Output_N41+Output_N46;
float Output_N85=0.0;
float param_27=(*sc_set0.UserUniforms).Tweak_N85;
Output_N85=param_27;
...
int l9_175=l9_170;
int param_28=Tweak_N99Layout_tmp;
int param_29=l9_175;
float2 param_30=Globals.Surface_UVCoord0;
bool param_31=(int(SC_USE_UV_TRANSFORM_Tweak_N99_tmp)!=0);
float3x3 param_32=(*sc_set0.UserUniforms).Tweak_N99Transform;
int2 param_33=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99_tmp);
bool param_34=(int(SC_USE_UV_MIN_MAX_Tweak_N99_tmp)!=0);
float4 param_35=(*sc_set0.UserUniforms).Tweak_N99UvMinMax;
bool param_36=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99_tmp)!=0);
float4 param_37=(*sc_set0.UserUniforms).Tweak_N99BorderColor;
float param_38=0.0;
bool l9_176=param_36&&(!param_34);
float l9_177=1.0;
float l9_178=param_30.x;
int l9_179=param_33.x;
if (l9_179==1)
{
l9_178=fract(l9_178);
}
...
param_30.x=l9_178;
float l9_183=param_30.y;
int l9_184=param_33.y;
if (l9_184==1)
{
l9_183=fract(l9_183);
}
...
float l9_190=param_30.x;
float l9_191=param_35.x;
float l9_192=param_35.z;
bool l9_193=l9_189;
float l9_194=l9_177;
...
float l9_199=param_30.y;
float l9_200=param_35.y;
float l9_201=param_35.w;
bool l9_202=l9_198;
float l9_203=l9_177;
...
float2 l9_206=param_30;
bool l9_207=param_31;
float3x3 l9_208=param_32;
if (l9_207)
{
...
param_30=l9_209;
float l9_210=param_30.x;
int l9_211=param_33.x;
bool l9_212=l9_176;
float l9_213=l9_177;
...
param_30.x=l9_210;
l9_177=l9_213;
float l9_221=param_30.y;
int l9_222=param_33.y;
bool l9_223=l9_176;
float l9_224=l9_177;
...
param_30.y=l9_221;
l9_177=l9_224;
float2 l9_232=param_30;
int l9_233=param_28;
int l9_234=param_29;
float l9_235=param_38;
...
float4 l9_242=sc_set0.Tweak_N99.sample(sc_set0.Tweak_N99SmpSC,l9_241.xy,bias(l9_235));
float4 l9_243=l9_242;
if (param_36)
{
l9_243=mix(param_37,l9_243,float4(l9_177));
}
...
float Noise_N83=0.0;
float2 param_39=(*sc_set0.UserUniforms).Port_Seed_N083;
float2 param_40=CoordsOut_N92;
param_39.x=floor(param_39.x*10000.0)*9.9999997e-05;
param_39.y=floor(param_39.y*10000.0)*9.9999997e-05;
param_39*=(param_40*0.5);
float2 l9_245=param_39;
float param_41=(snoise(l9_245)*0.5)+0.5;
param_41=floor(param_41*10000.0)*9.9999997e-05;
Noise_N83=param_41;
float4 Output_N94=float4(0.0);
float4 param_42=Output_N89;
float4 param_43=float4(Noise_N83);
float3 l9_246=param_43.xyz*param_42.xyz;
float4 param_44;
param_44=float4(l9_246.x,l9_246.y,l9_246.z,param_44.w);
float3 l9_247=mix(param_42.xyz,param_44.xyz,float3(param_43.w));
param_44=float4(l9_247.x,l9_247.y,l9_247.z,param_44.w);
...
float2 l9_249=floor(mod(l9_248.xy,float2(4.0)));
float l9_250=(mod(dot(l9_249,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_45<l9_250)
{
discard_fragment();
}
...
float4 l9_251=fast::max(param_46,float4(0.0));
float4 param_47=l9_251;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_254=fast::clamp(l9_253.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_254=fast::clamp(dot(l9_253.xyz,float3(l9_253.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_254=(1.0-dot(l9_253.xyz,float3(0.33333001)))*l9_253.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_254=(1.0-fast::clamp(dot(l9_253.xyz,float3(1.0)),0.0,1.0))*l9_253.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_254=fast::clamp(dot(l9_253.xyz,float3(1.0)),0.0,1.0)*l9_253.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_254=fast::clamp(dot(l9_253.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_254=dot(l9_253.xyz,float3(0.33333001))*l9_253.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_254=1.0-fast::clamp(dot(l9_253.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_255=l9_254;
float l9_256=l9_255;
float l9_257=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_256;
float3 l9_258=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_252.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_259=float4(l9_258.x,l9_258.y,l9_258.z,l9_257);
param_48=l9_259;
}
else
{
...
float4 l9_301=l9_262;
float3 l9_302=l9_301.xyz;
float3 l9_303=l9_302;
float3 l9_304=l9_260.xyz;
...
l9_261=float4(l9_305.x,l9_305.y,l9_305.z,l9_261.w);
float3 l9_306=mix(l9_302,l9_261.xyz,float3(l9_260.w));
l9_261=float4(l9_306.x,l9_306.y,l9_306.z,l9_261.w);
l9_261.w=1.0;
float4 l9_307=l9_261;
param_48=l9_307;
}
else
{
