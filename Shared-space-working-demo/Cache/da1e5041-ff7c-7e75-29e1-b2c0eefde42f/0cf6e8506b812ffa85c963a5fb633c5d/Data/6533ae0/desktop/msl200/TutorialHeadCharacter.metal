...
//float Tweak_N6 4408
//float alpha 4412
//float3 Port_Normal_N002 4416
//float Port_Input1_N003 4432
//float depthRef 4436
//}
...
float Output_N5=0.0;
float param_3=(*sc_set0.UserUniforms).Tweak_N5;
Output_N5=param_3;
float Output_N6=0.0;
float param_4=(*sc_set0.UserUniforms).Tweak_N6;
Output_N6=param_4;
float Rim_N2=0.0;
float3 param_5=(*sc_set0.UserUniforms).Port_Normal_N002;
float param_6=Output_N5;
...
float l9_1=abs(dot(-param_9.ViewDirWS,param_5));
float param_8=pow(1.0-l9_1,param_6);
...
float param_11=(*sc_set0.UserUniforms).alpha;
Output_N126=param_11;
...
float4 l9_5=fast::max(param_13,float4(0.0));
float4 param_14=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{
